...
describe("storage.HttpStorage", function () {
    ...
    it("update URL should be /store/annotations/idAnnotation by default", function () {
        store.update({
            text: "Donkeys on giraffes",
            id: 123
        });
    ...
    it("delete URL should be /store/annotations/idAnnotation by default", function () {
        store["delete"]({
            text: "Donkeys on giraffes",
            id: 123
        });
    ...
    it("should request custom URLs as specified by its options", function () {
        ...
        store.options.urls.update = '/idAnnotation/updateMe';
        store.options.urls.destroy = '/idAnnotation/destroyMe';
    ...
    it("should generate URLs with substitution markers in query strings", function () {
        store.options.prefix = '/some/prefix';
        store.options.urls.update = '/update?foo&id=idAnnotation';
        store.options.urls.destroy = '/delete?id=idAnnotation&foo';
